...
- [ ] **CP4 Delivery Gate**: CP4 verification commit pushed; GitHub Actions PostgreSQL 16 jobs, backend, migration/drift, dependency, frontend, and required PR checks complete green.
